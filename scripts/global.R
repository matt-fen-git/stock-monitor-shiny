...
# Read Data
stock_data_list <- readRDS("~/Kaggle Projects/Stock Monitor/data/stock_data_list.rds")

all_dips_data <- data.table::fread("~/Kaggle Projects/Stock Monitor/data/all_dips_data.csv") %>% as.data.frame()
